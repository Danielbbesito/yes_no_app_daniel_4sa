...
class HerMessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //Formtear la hora de envio 
    final formattedTime = DateFormat("hh:mma").format(message.timeSent);
          ...
          child: Padding(
            ...
            child: Stack(
              children: [
                ...
                //Hora en la esquina inferior derecha con funete mas pequeña
                Positioned(bottom: 0,
                right: 0,
                child:  Text(
                  formattedTime,
          ...
          child: Image.network(
            ...
            loadingBuilder: (context, child, loadingProgress) {
              ...
              return Container(
                ...
                child: const Text("Ester está enviando una imagen"),
              );
            },
          ),
        ),
